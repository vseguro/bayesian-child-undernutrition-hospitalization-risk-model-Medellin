...
# the AUC (Area Under the Curve) using data from each child (from the final 
# dataset) and samples obtained (simulations) from the posterior distributions 
...
sheme_poste <- LoadData(file_name = "posterior_schemes.txt", data_type = "processed/fixed_effects_samples")
